...
else if (num%3 ==0 && num%3 ==0)return "fizzbuzz";
else return false;
}
...
function esPrimo(num) {
  ...
  for(var i =2; i<8;i++){
   if (i==4 || i==6)continue;
   if (num ==4 || num ==6) {primo+=1;
   break;}
   if (num % i ==0 && num!=i || num<2){primo += 1;}
   if (num == 4 || num == 6){primo +=1;break;}
  }
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
    ...
    var digitos;
    if (Number.isInteger(num)){digitos=(num.toString()).length;}
    else digitos=(num.toString()).length-1;
